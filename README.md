# nvim-treesitter-queries-jsonnet

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsonnet/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsonnet/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jsonnet**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-jsonnet",
...
- [ ] Changes are scoped to `jsonnet` — do not include files for other languages
